...
//Recorremos cada palabra del texto y la añadimos en el diccionario o aumentamos su valor.
...
//Vamos a formatearlo para que nos lo de como se pide en la solución
let solucion="";
for (let [clave, valor] of Object.entries(diccionario)) {
  solucion+=(`${clave}${valor}`);
}
